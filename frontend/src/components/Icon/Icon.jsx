...
const ICONS = {
  ...
  gavel: (
    <svg viewBox="0 0 24 24" fill="currentColor">
      <path d="M1 21h12v2H1v-2zM5.245 8.07l2.83-2.827 9.899 9.9-2.828 2.828-9.9-9.9zm7.072-7.07l5.656 5.656-2.828 2.829-5.657-5.657 2.829-2.828zm-8.485 8.485l5.656 5.657-2.828 2.828-5.657-5.657 2.829-2.828z"/>
    </svg>
  ),
  devices: (
    <svg viewBox="0 0 24 24" fill="currentColor">
  ...
  dentistry: (
    <svg viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 2C7.58 2 4 5.58 4 10c0 2.6 1.25 4.9 3.19 6.36L7 22l5-2 5 2-.19-5.64C18.75 14.9 20 12.6 20 10c0-4.42-3.58-8-8-8zm-1 12H9v-2h2v2zm0-4H9V8h2v2zm4 4h-2v-2h2v2zm0-4h-2V8h2v2z"/>
    </svg>
  ),
  clinical_notes: (
    <svg viewBox="0 0 24 24" fill="currentColor">
  ...
  biotech: (
    <svg viewBox="0 0 24 24" fill="currentColor">
      <path d="M10.5 4.5c.28 0 .5.22.5.5v1.65l-2 2.33V5c0-.28.22-.5.5-.5h1M13 2H8C6.9 2 6 2.9 6 4v5.38L2 14.05V20c0 1.1.9 2 2 2h13c1.1 0 2-.9 2-2v-5.95l-4-4.67V4c0-1.1-.9-2-2-2zm3 18H4v-4.5l3.5-4.08V11h6v.42L17 15.5V20z"/>
    </svg>
  ),
  sms: (
    <svg viewBox="0 0 24 24" fill="currentColor">
